...
<p align="justify"><b>Atualização:</b><br><br>Implementação de backup do banco de dados local em uma conta de armazenamento da nuvem da Azure. O envio é feito de forma manual ou automatizada ao sair da aplicação.</p>
